        ...
        methods:{
            ...
            deleteArticle(article){
                ...
                if(result == true){
                    ...
                    ActicleAPI.DeleteArticleById({articleId:article.articleId}).then((result)=>{
                        ...
                        Log.info("ArticleEdit.vue","删除文章操作[]",[result.data.msg])
                    }).catch((error)=>{
            ...
            */
            ...
            saveDraftClick(){
                ...
                this.postArticle('draft').then((result) =>{
                    ...
                    console.log(result);
                    Log.info("ArticleEdit.vue",result.data.msg)
                    that.tips = "草稿保存成功"
            ...
            */
            autoSave(){
               ...
               // Log.info("ArticleEdit.vue",'avilableSaveFlag=[]',[that.avilableSaveFlag])
                ...
                if(that.avilableSaveFlag == true){
                    ...
                    setTimeout(function () {
                        ...
                        Log.info("ArticleEdit.vue","定时时间到")
            ...
            */
            ...
            getActicleList(_page,_acticleTYpe){
                ...
                ActicleAPI.GetActicleList({page: _page,acticleTYpe:_acticleTYpe}).then((result)=>{
                    ...
                    result = result.data
                    Log.info("ArticleEdit.vue","请求结果:[],数据:[]",[result.msg,JSON.stringify(result.data)])
                    ...
                    Log.error("ArticleEdit.vue","请求失败"+error)
                })
...
<style scoped src="./css/article-edit.css">
